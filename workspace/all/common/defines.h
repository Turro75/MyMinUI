...
#define PWR_SLEEP_DELAY_PATH SHARED_USERDATA_PATH "/sleep-delay-sec"
#define PWR_POWEROFF_DELAY_PATH SHARED_USERDATA_PATH "/poweroff-delay-sec"
...
#define TRIAD_RED 			0xff,0x00,0x00
