...
/** 
 * struct sunxi_phys_data - structure to get physical address from ion handle
 * @handle:		the ion handle
 * @phys_addr:		the physical address returned
 * @size:		the size of the allocation
 *
 * Used to get the physical address from an ion handle
 */
...
#define ION_CACHED_FLAG 1
#define ION_CACHED_NEEDS_SYNC_FLAG 2
